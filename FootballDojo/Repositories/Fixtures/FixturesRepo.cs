...
{
    public class FixturesRepo : IFixturesRepo
    {
        private readonly FootballDojoClient _client;

        public FixturesRepo(FootballDojoClient client)
        {
            _client = client;
        }
        ...
        public async Task<Lineups> GetLineupByFixtureIdAndTeamIdAsync(int fixtureId, int teamId)
        {
